  ...
  getResults(){
    ...
    // 'http://localhost/wp/Fictional-University/wp-json/wp/v2/posts?search='
      ...
      $.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), (results) => {
        this.resultsDiv.html(`
          <div class="row">
            ...
            <div class="one-third">
              ...
              ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No programs information match that search. <a href="${universityData.root_url}/programs">View all programs</a></p>`}
        ...
        // delete this old code a bit later on
        /*
      $.when(
